...
export default function PractitionerAppointment() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* Appointment List */}
        <Text style={styles.appointmentListTitle}>Patient Appointments</Text>
...
const styles = StyleSheet.create({
  ...
  patient: { fontSize: 11, color: '#666', marginTop: 2 },
  emptyContainer: {
    alignItems: 'center',
    paddingVertical: 40,
  },
