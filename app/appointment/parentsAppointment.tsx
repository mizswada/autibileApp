...
const styles = StyleSheet.create({
  ...
  dayShort: { width: '14.2%', textAlign: 'center', color: '#1E293B', fontWeight: '600', fontSize: 13 },
  ...
  dayCellAppt: { backgroundColor: '#4db5ff', borderRadius: 10 },
  dayNumAppt: { color: '#fff', fontWeight: 'bold' },
  appointmentListTitle: { fontSize: 20, fontWeight: 'bold', color: '#1E293B', marginVertical: 12 },
  appointmentRow: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#fff',
  ...
  practitioner: { fontSize: 11, color: '#9CA3AF', marginTop: 2 },
  emptyContainer: {
    alignItems: 'center',
    paddingVertical: 40,
  },
  ...
  modalDate: { fontSize: 15, color: '#4db5ff', fontWeight: 'bold', marginBottom: 6 },
  modalTitle: { fontSize: 18, fontWeight: 'bold', color: '#1E293B', marginBottom: 4 },
  modalSummary: { fontSize: 14, color: '#1E293B', textAlign: 'center', marginBottom: 8 },
  modalPractitioner: { fontSize: 12, color: '#9CA3AF', textAlign: 'center', marginBottom: 16 },
  modalButton: {
    backgroundColor: '#4db5ff',
    paddingVertical: 12,
  ...
  appointmentItemTitle: { fontSize: 14, fontWeight: 'bold', color: '#1E293B', marginBottom: 4 },
  appointmentItemTime: { fontSize: 12, color: '#9CA3AF', marginBottom: 2 },
  appointmentItemPractitioner: { fontSize: 11, color: '#9CA3AF' },
  cancelButton: {
    backgroundColor: '#E1F5FF',
    paddingVertical: 12,
    paddingHorizontal: 24,
  ...
  cancelButtonText: { color: '#4db5ff', fontSize: 16, fontWeight: 'bold', textAlign: 'center' },
});
