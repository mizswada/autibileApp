...
const features = [
  { id:1, path: 'therapy/TherapyPlanList', label: 'Theraphy Plan', icon: require('@/assets/images/calendar.png') },
  // { key: 'mchat', label: 'M-CHAT-R', icon: require('@/assets/images/passFail.png') },
  { id:2, path: 'appointment/practitionerAppointment', label: 'Appointment', icon: require('@/assets/images/calendar.png') },
//   { key: 'therapy', label: 'Therapy Plan', icon: require('@/assets/images/medicalBag.png') },
  { id:3, path: 'diaryReport/practitionerReport', label: 'Diary Report', icon: require('@/assets/images/report.png') },
];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.cardContainer}>
        <View style={styles.notificationCard}>
          ...
          <Text style={styles.notifTitle}>Hi, Therapists</Text>
